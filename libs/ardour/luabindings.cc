...
LuaBindings::common (lua_State* L)
{
	...
	luabridge::getGlobalNamespace (L)
		...
		.addFunction ("add_section", &Locations::add_section)
		...
		.addRefFunction ("get_connections", &Port::get_connections)
		...
		.addFunction ("route_group", &RouteGroupMember::route_group)
		.endClass ()
		...
		.addFunction ("normalize", &AudioRegion::normalize)
		.endClass ()
...
#undef CONFIG_VARIABLE_SPECIAL
	...
	luabridge::getGlobalNamespace (L)
		...
		.addCFunction ("region_loudness", ARDOUR::LuaAPI::region_loudness)
	...
	luabridge::getGlobalNamespace (L)
		...
		.endClass ()
		.beginClass <DSP::StereoCorrelation> ("StereoCorrelation")
		.addConstructor <void (*) (float, float, float)> ()
		.addFunction ("process", &DSP::StereoCorrelation::process)
		.addFunction ("read", &DSP::StereoCorrelation::read)
		.addFunction ("reset", &DSP::StereoCorrelation::reset)
		.endClass ()
...
LuaBindings::non_rt (lua_State* L)
{
	...
	luabridge::getGlobalNamespace (L)
		...
		.addExtCFunction ("new_audio_track", ARDOUR::LuaAPI::new_audio_track)
		.addExtCFunction ("new_audio_route", ARDOUR::LuaAPI::new_audio_route)
		.addExtCFunction ("new_midi_track", ARDOUR::LuaAPI::new_midi_track)
		...
		.addFunction ("undo", &Session::undo)
		.addFunction ("redo", &Session::redo)
		.addFunction ("undo_depth", &Session::undo_depth)
		.addFunction ("redo_depth", &Session::redo_depth)
		.endClass ()
